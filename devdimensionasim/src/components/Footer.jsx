      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-8">
          ...
          <div>
            {/* Logo */}
            <div className="mb-6">
              <img src={Logo} alt="ProspectRoute Logo" className="h-10 w-auto mb-2" />
              <div className="text-secondary text-lg font-bold">PROSPECTROUTE</div>
            </div>
          ...
          <div>
            <ul className="space-y-3 text-secondary text-sm">
              <li className="hover:opacity-80 cursor-pointer">How it works</li>
          ...
          <div>
            <ul className="space-y-3 text-secondary text-sm">
              ...
              <li className="hover:opacity-80 cursor-pointer">Privacy Policy</li>
              <li className="hover:opacity-80 cursor-pointer">Terms & Conditions</li>
            </ul>
          </div>
